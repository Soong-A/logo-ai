              ...
              <CardContent className="p-6 space-y-6">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <Textarea
                    ...
                    className="mt-1 h-20 px-4 py-3 border-accent resize-none"
                  />
                </div>
            ...
            <Card className="h-full rounded-3xl dark:bg-accent/20">
              <CardContent className="p-6 h-full flex flex-col">
                {generatedLogo ? (
                  ...
                  >
                    {/* Logo预览框 */}
                    <div className="flex-1 aspect-square rounded-2xl border border-accent/30 flex items-center justify-center p-4 bg-slate-50 dark:bg-slate-900">
                      <img
                        src={generatedLogo}
                        alt="Generated logo"
                  ...
                  // 内容不完整提示
                  <motion.div
                    className="flex-1 rounded-2xl flex items-center justify-center text-center p-6 border-2 border-yellow-400 bg-yellow-50 dark:bg-yellow-900/20"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    transition={{ duration: 0.4 }}
                  >
                    <div className="max-w-md space-y-4">
                      ...
                      <p className="text-yellow-700 dark:text-yellow-300">
                        请先填写左侧的必填信息
                        <br />
                        <span className="text-sm">创意概念和设计风格是生成Logo的必需信息</span>
                      </p>
                      <div className="pt-2">
                        <div className="inline-flex items-center gap-2 px-3 py-1 bg-yellow-100 dark:bg-yellow-800 rounded-full text-yellow-800 dark:text-yellow-200 text-sm">
                  ...
                  // 未生成：引导提示
                  <motion.div
                    className="flex-1 rounded-2xl flex items-center border-2 dark:border-primary/40 border-dashed justify-center text-center p-6"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    transition={{ duration: 0.4 }}
                  >
                    <div className="max-w-md space-y-4">
                      <IconPalette className="h-16 w-16 mx-auto text-primary opacity-50" />
